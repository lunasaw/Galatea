#!/usr/bin/env python3
"""Plan or execute v3 route preflight, synthetic calibration or gated private review."""
...
def main() -> int:
    ...
    parser.add_argument('--config', dest='config_path', type=Path, default=ROOT / 'configs/topic-axes-review-v3.yaml')
