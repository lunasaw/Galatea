#!/usr/bin/env python3
"""Legacy, review-only WeChat export preprocessor.
...
This script is retained to reproduce the historical preprocessing workflow. It
is not the project's governed data entry point, and its outputs remain blocked
for formal training. Use import_chat.py and build_dataset.py for the current
contract.
"""
