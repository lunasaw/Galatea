...
class RayBackend:
    def __init__(self, clients, *, expected_heads, endpoint_mode='separate_endpoints', probe, binding, runtime_envs):
        ...
        self.cluster_id = digest({'schema_version': 'galatea.cluster/v1', 'topology': endpoint_mode,
