...
import { standardDecoratorPlugin, vitestExecArgv } from '/data/ai/chenzhangyue/code/deepseek-harness/vitest.shared.ts'
...
export default defineConfig({
  ...
  plugins: [
    ...
    tsconfigPaths({ root: harnessRoot, projects: ['./tsconfig.base.json'] }),
  ],
  resolve: {
    alias: {
      ...
      '@deepseek-ai/dsh-invariants': `${harnessRoot}/packages/core/invariants/src/index.ts`,
      '@deepseek-ai/dsh-llm': `${harnessRoot}/packages/llm/llm/src/index.ts`,
      '@deepseek-ai/dsh-scope': `${harnessRoot}/packages/core/scope/src/index.ts`,
      '@deepseek-ai/dsh-session': `${harnessRoot}/packages/core/session/src/index.ts`,
      '@deepseek-ai/dsh-session-projection': `${harnessRoot}/packages/session/session-projection/src/index.ts`,
      ...
      '@deepseek-ai/dsh-typert-protocol': `${harnessRoot}/packages/typert/protocol/src/index.ts`,
      '@deepseek-ai/dsh-user-approval': `${harnessRoot}/packages/interaction/user-approval/src/index.ts`,
      '@deepseek-ai/dsh-util-values': `${harnessRoot}/packages/util/values/src/index.ts`,
    },
  },
  test: {
