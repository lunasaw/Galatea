#!/usr/bin/env python3
"""Plan, execute or replay the Opus blind reference route."""
import argparse
import json
import os
...
from wechat_persona.topic_blind_reference_opus import run_reference


def main():
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument('--scope', choices=['preflight', 'private'], required=True)
    parser.add_argument('--config', dest='config_path', type=Path, default=ROOT / 'configs/topic-blind-reference-opus-v1.yaml')
