#!/usr/bin/env python3
"""Plan or execute v4 route preflight, synthetic calibration or gated private review."""
...
def main() -> int:
    ...
    parser.add_argument('--scope', choices=['preflight', 'calibration', 'private_review'], required=True)
    parser.add_argument('--config', dest='config_path', type=Path, default=ROOT / 'configs/topic-axes-review-v4.yaml')
    ...
    try:
        report = run_review(**args, private_inputs=private_inputs)
