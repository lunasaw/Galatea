...
KIND_MAP = {
    "text": "text", "emoji": "emoji", "image": "image", "voice": "voice",
    "video": "video", "file": "file", "quote": "quote", "link": "link",
    "system": "system", "payment": "payment", "transfer": "payment",
    "redpacket": "payment", "call": "call", "voip": "call",
    "chathistory": "other",
}
...
def _role(raw: Mapping[str, Any], speaker_map: Mapping[str, str] | None) -> str:
    if raw.get("is_sent") is True or raw.get("isSent") is True:
        return "self"
...
def normalize_message(
    ...
    kind_raw = str(raw.get("message_kind", raw.get("kind", raw.get("type", "text")))).casefold().replace("_", "")
